...
A personal partner relationship and communication command center for an SBA 504
...
- **Full database schema** — all ~35 tables from the spec (partners,
...
- **Sample data** — new accounts are seeded with clearly-labeled fictional
  data (24 partners, 8 institutions, meetings, promises, deals, loans, a
...
- **Screens** — Dashboard (priority-ordered: missing notes → overdue promises
  → loan updates due → weekly Top 10 → upcoming meetings), Partners (views,
  typo-tolerant search), Partner profile (timeline, personal details,
  promises, institution history, text-and-log flow), Institutions, Add
  Partner (duplicate check, follow-up timing), Excel Import wizard (mapping,
